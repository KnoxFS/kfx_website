const socialLinks = [
    {
        name: 'Facebook',
        href: 'https://www.facebook.com/profile.php?id=100075467036632',
        icon: (
            <svg className="w-6 h-6 hover:text-gray-200 duration-150" fill="none" viewBox="0 0 48 48">
                ...
                <defs>
                    <clipPath id="fb"><path fill="currentColor" d="M0 0h48v48H0z" /></clipPath>
                </defs>
            </svg>
        ),
    },
    {
        ...
        icon: (
            <svg className="w-6 h-6 hover:text-gray-200 duration-150" fill="none" viewBox="0 0 48 48">
                ...
                <defs>
                    <clipPath id="tw"><path fill="currentColor" d="M0 0h48v48H0z" /></clipPath>
                </defs>
            </svg>
        ),
    },
    {
        name: 'LinkedIn',
        href: 'https://linkedin.com/company/knoxfs',
        icon: (
            <svg className="w-6 h-6 hover:text-gray-200 duration-150" fill="none" viewBox="0 0 48 48">
                <g clipPath="url(#li)">
                ...
                <defs>
                    <clipPath id="li"><path fill="currentColor" d="M0 0h48v48H0z" /></clipPath>
                </defs>
            </svg>
        ),
    },
            ...
            <div className="custom-screen">
                <div className="mt-10 py-8 border-t border-gray-800 items-center justify-between sm:flex">
                    <p className="text-gray-400 text-center">
                        © 2024 knoxFs Inc. All rights reserved.
                    </p>

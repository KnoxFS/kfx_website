                    ...
                    <form className="mt-8 space-y-5">
                        <div>
                            ...
                            <input
                                type="email"
                                required
                                className="w-full mt-2 text-gray-300 bg-gray-800 focus:bg-gray-900 focus:border-gray-800 px-3 py-2 text-gray-500 outline-none border border-gray-800 shadow-sm rounded-lg duration-150"
                            />
                        </div>
                        <div>
                        ...
                        <button
                            role="button"
                            className="w-full text-gray-800 bg-gray-100 hover:bg-gray-200 ring-offset-2 focus:ring rounded-lg px-4 py-2.5 font-medium text-sm text-center duration-150"
                        >
                            Sign in
                        </button>
                        <button
